...
#packer build -on-error=ask alma_87_postgres_15.json
# alma 8.5 - yugabyte
...
# alma 8.7 - yugabyte
#packer build -on-error=ask alma_87_yb_preview.json
#packer build -on-error=ask alma_87_yb_sts.json
# alma 9.1 - yugabyte
#packer build -on-error=ask alma_91_yb_preview.json
# alma 8.8 - yugabyte
packer build -on-error=ask alma_88_yb_lts.json
packer build -on-error=ask alma_88_yb_sts.json
#packer build -on-error=ask alma_88_yb_preview.json
# alma 9.2 - yugabyte
#packer build -on-error=ask alma_92_yb_preview.json
