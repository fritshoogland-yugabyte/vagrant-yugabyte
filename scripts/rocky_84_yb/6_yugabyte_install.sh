...
YUGABYTE_VERSION=yugabyte-2.7.1.1
...
chown -R yugabyte.yugabyte /opt/yugabyte/$YUGABYTE_VERSION
echo "run post_install.sh"
su -c "cd /opt/yugabyte/$YUGABYTE_VERSION; ./bin/post_install.sh" yugabyte
